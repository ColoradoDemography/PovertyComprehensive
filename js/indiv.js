...
function init() {
	...
	dojo.byId("subtitle").innerHTML = "Source: Table B17024, ACS 2016-2020 5Y : Census Tracts";
}
...
function initOperationalLayer(map) {
	...
	featureLayer = new esri.layers.FeatureLayer("https://services.arcgis.com/IamIM3RJ5xHykalK/arcgis/rest/services/Poverty_Comprehensive_1620/FeatureServer/0", {

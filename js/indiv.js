...
var map, featureLayer, infoTemplate, legend;
...
function init() {
	...
	dojo.byId("subtitle").innerHTML = "Source: Table B17024, ACS 2019-2023 5Y : Census Tracts";
}
...
function initOperationalLayer(map) {
	...
	featureLayer = new esri.layers.FeatureLayer("https://services.arcgis.com/IamIM3RJ5xHykalK/arcgis/rest/services/Poverty_Comprehensive_1923/FeatureServer/0", {
	...
	//for place layer
	var pren = new esri.symbol.SimpleFillSymbol(esri.symbol.SimpleFillSymbol.STYLE_NULL, new esri.symbol.SimpleLineSymbol(esri.symbol.SimpleLineSymbol.STYLE_SOLID, new dojo.Color([0, 0, 255, 0.5]), 1), new dojo.Color([0, 0, 0, 0]));
